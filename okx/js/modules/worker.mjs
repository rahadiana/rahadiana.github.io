...
(async function() {
  ...
  // Prefer using metrics-wrapper if available (centralized API). Attempt dynamic import first, fall back to global.
  let _metricsWrapper = null;
  try {
    const mod = await import('./metrics-wrapper.mjs');
    _metricsWrapper = (mod && mod.default) ? mod.default : mod;
  } catch (e) {
    _metricsWrapper = (typeof globalThis !== 'undefined' ? globalThis.metricsWrapper : null);
  }

  if (_metricsWrapper) {
    computeKyleLambda = (...a) => { try { if (typeof _metricsWrapper.computeKyleLambda === 'function') { const r = _metricsWrapper.computeKyleLambda(...a); if (typeof r !== 'undefined') return r; } } catch(e){}; return (globalThis.AnalyticsCore && typeof globalThis.AnalyticsCore.computeKyleLambda === 'function') ? globalThis.AnalyticsCore.computeKyleLambda(...a) : undefined; };
    computeVWAPBands = (...a) => { try { if (typeof _metricsWrapper.computeVWAPBands === 'function') { const r = _metricsWrapper.computeVWAPBands(...a); if (typeof r !== 'undefined') return r; } } catch(e){}; return (globalThis.AnalyticsCore && typeof globalThis.AnalyticsCore.computeVWAPBands === 'function') ? globalThis.AnalyticsCore.computeVWAPBands(...a) : undefined; };
    computeCVD = (...a) => { try { if (typeof _metricsWrapper.computeCVD === 'function') { const r = _metricsWrapper.computeCVD(...a); if (typeof r !== 'undefined') return r; } } catch(e){}; return (globalThis.AnalyticsCore && typeof globalThis.AnalyticsCore.computeCVD === 'function') ? globalThis.AnalyticsCore.computeCVD(...a) : undefined; };
    computeRVOL = (...a) => { try { if (typeof _metricsWrapper.computeRVOL === 'function') { const r = _metricsWrapper.computeRVOL(...a); if (typeof r !== 'undefined') return r; } } catch(e){}; return (globalThis.AnalyticsCore && typeof globalThis.AnalyticsCore.computeRVOL === 'function') ? globalThis.AnalyticsCore.computeRVOL(...a) : undefined; };
    computeTier1Normalized = (...a) => { try { if (typeof _metricsWrapper.computeTier1Normalized === 'function') { const r = _metricsWrapper.computeTier1Normalized(...a); if (typeof r !== 'undefined') return r; } } catch(e){}; return (globalThis.AnalyticsCore && typeof globalThis.AnalyticsCore.computeTier1Normalized === 'function') ? globalThis.AnalyticsCore.computeTier1Normalized(...a) : undefined; };
    computeVPIN = (...a) => { try { if (typeof _metricsWrapper.computeVPIN === 'function') { const r = _metricsWrapper.computeVPIN(...a); if (typeof r !== 'undefined') return r; } } catch(e){}; return (globalThis.AnalyticsCore && typeof globalThis.AnalyticsCore.computeVPIN === 'function') ? globalThis.AnalyticsCore.computeVPIN(...a) : undefined; };
    computeHurstExponent = (...a) => { try { if (typeof _metricsWrapper.computeHurstExponent === 'function') { const r = _metricsWrapper.computeHurstExponent(...a); if (typeof r !== 'undefined') return r; } } catch(e){}; return (globalThis.AnalyticsCore && typeof globalThis.AnalyticsCore.computeHurstExponent === 'function') ? globalThis.AnalyticsCore.computeHurstExponent(...a) : undefined; };
    computeVolumeProfilePOC = (...a) => { try { if (typeof _metricsWrapper.computeVolumeProfilePOC === 'function') { const r = _metricsWrapper.computeVolumeProfilePOC(...a); if (typeof r !== 'undefined') return r; } } catch(e){}; return (globalThis.AnalyticsCore && typeof globalThis.AnalyticsCore.computeVolumeProfilePOC === 'function') ? globalThis.AnalyticsCore.computeVolumeProfilePOC(...a) : undefined; };
    computeDepthImbalance = (...a) => { try { if (typeof _metricsWrapper.computeDepthImbalance === 'function') { const r = _metricsWrapper.computeDepthImbalance(...a); if (typeof r !== 'undefined') return r; } } catch(e){}; return (globalThis.AnalyticsCore && typeof globalThis.AnalyticsCore.computeDepthImbalance === 'function') ? globalThis.AnalyticsCore.computeDepthImbalance(...a) : undefined; };
    calculateVolDurability = (...a) => { try { if (typeof _metricsWrapper.calculateVolDurability === 'function') { const r = _metricsWrapper.calculateVolDurability(...a); if (typeof r !== 'undefined') return r; } } catch(e){}; return (globalThis.AnalyticsCore && typeof globalThis.AnalyticsCore.calculateVolDurability === 'function') ? globalThis.AnalyticsCore.calculateVolDurability(...a) : undefined; };
    calculateVolRatio = (...a) => { try { if (typeof _metricsWrapper.calculateVolRatio === 'function') { const r = _metricsWrapper.calculateVolRatio(...a); if (typeof r !== 'undefined') return r; } } catch(e){}; return (globalThis.AnalyticsCore && typeof globalThis.AnalyticsCore.calculateVolRatio === 'function') ? globalThis.AnalyticsCore.calculateVolRatio(...a) : undefined; };
    computeAllSmartMetrics = (...a) => { try { if (typeof _metricsWrapper.computeAllSmartMetrics === 'function') { const r = _metricsWrapper.computeAllSmartMetrics(...a); if (typeof r !== 'undefined') return r; } } catch(e){}; return (globalThis.AnalyticsCore && typeof globalThis.AnalyticsCore.computeAllSmartMetrics === 'function') ? globalThis.AnalyticsCore.computeAllSmartMetrics(...a) : undefined; };
    computeMicrostructureMetrics = (...a) => { try { if (typeof _metricsWrapper.computeMicrostructureMetrics === 'function') { const r = _metricsWrapper.computeMicrostructureMetrics(...a); if (typeof r !== 'undefined') return r; } } catch(e){}; return (globalThis.AnalyticsCore && typeof globalThis.AnalyticsCore.computeMicrostructureMetrics === 'function') ? globalThis.AnalyticsCore.computeMicrostructureMetrics(...a) : undefined; };
  }
    ...
    try {
      ...
      switch (type) {
        case 'computeSmartMetrics':
          result = (typeof computeAllSmartMetrics === 'function') ? computeAllSmartMetrics(payload.data) : {};
          break;

        case 'computeBatch':
          result = {};
          for (const [coin, data] of Object.entries(payload.coins || {})) {
            const smart = (typeof computeAllSmartMetrics === 'function') ? computeAllSmartMetrics(data) : {};
            result[coin] = {
              smart,
              volDur2h: (typeof calculateVolDurability === 'function') ? calculateVolDurability(data, '2h') : null,
              volDur24h: (typeof calculateVolDurability === 'function') ? calculateVolDurability(data, '24h') : null,
              volRatio2h: (typeof calculateVolRatio === 'function') ? calculateVolRatio(data, '2h') : null
            };
          }
          break;
        ...
        case 'computeMicrostructure':
          result = (typeof computeMicrostructureMetrics === 'function') ? computeMicrostructureMetrics(payload.data) : {};
          break;
  ...
  async function computeFullAnalytics(data) {
    ...
    for (const tf of timeframes) {
      volMetrics[tf] = {
        durability: (typeof calculateVolDurability === 'function') ? calculateVolDurability(data, tf) : null,
        ratio: (typeof calculateVolRatio === 'function') ? calculateVolRatio(data, tf) : null
      };
    }
    ...
    if (typeof computeKyleLambda === 'function') {
      try {
        kyle = computeKyleLambda(hist, { lookbackPeriods: 20, minSamples: 10, smoothingWindow: 5 });
        vwap = (typeof computeVWAPBands === 'function') ? computeVWAPBands(hist, { lookbackPeriods: 120 }) : null;
        cvd = (typeof computeCVD === 'function') ? computeCVD(hist, { window: 'all', normalizationMethod: 'total' }) : null;
        rvol = (typeof computeRVOL === 'function') ? computeRVOL(hist, { baselinePeriods: 14 }) : null;
        if (typeof computeTier1Normalized === 'function') {
          Object.assign(tier1, computeTier1Normalized({ kyleLambda: kyle, vwapBands: vwap, cvd: cvd, rvol: rvol }));
        } else {
        ...
        for (const k of ['kyle','vwap','cvd','rvol']) {
          ...
          if (tier1 && Object.prototype.hasOwnProperty.call(tier1, k) && tier1[k] && typeof tier1[k].normalized === 'undefined') {
    ...
    const vpin = (typeof computeVPIN === 'function') ? computeVPIN(hist, { lookbackBars: 50, minSamples: 10 }) : null;
    const hurst = (typeof computeHurstExponent === 'function') ? computeHurstExponent(hist, { minSamples: 50 }) : null;
    const vp = (typeof computeVolumeProfilePOC === 'function') ? computeVolumeProfilePOC(hist, { bins: 24 }) : null;
    let depth = null;
    if (typeof computeDepthImbalance === 'function') {
      depth = computeDepthImbalance(data.snapshot || data);
    }
    ...
    if (vwap === null) {
      const cpuVW = (typeof computeVWAPBands === 'function') ? computeVWAPBands(hist, { lookbackPeriods: 120 }) : null;
