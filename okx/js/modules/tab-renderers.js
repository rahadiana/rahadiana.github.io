...
(function () {
    ...
    function computeATR(history, periods = 14) {
        try {
            if (typeof window !== 'undefined' && window.metricsWrapper && typeof window.metricsWrapper.computeATR === 'function') {
                return window.metricsWrapper.computeATR(history, periods);
            }
        } catch (e) { /* fallthrough */ }
    ...
    function getSmartMetrics(data) {
        ...
        if (typeof getUnifiedSmartMetrics === 'function') return getUnifiedSmartMetrics(data);
    ...
    function renderSignalLab() {
        try {
            ...
            try {
                const core = (typeof window !== 'undefined' && window.metricsWrapper) ? window.metricsWrapper : ((typeof globalThis !== 'undefined' && globalThis.AnalyticsCore) ? globalThis.AnalyticsCore : (typeof AnalyticsCore !== 'undefined' ? AnalyticsCore : null));
