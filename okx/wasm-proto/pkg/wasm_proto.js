 ...
 */
export function compute_double(input) {
    const ret = wasm.compute_double(input);
    return ret;
}
 ...
 * @returns {Float64Array}
 */
export function compute_vwap(prices, vols) {
    const ret = wasm.compute_vwap(prices, vols);
    return ret;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('wasm_proto_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
